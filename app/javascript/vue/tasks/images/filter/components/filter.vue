...
import UsersComponent from 'tasks/collection_objects/filter/components/filters/user.vue'
import BiocurationsComponent from 'tasks/collection_objects/filter/components/filters/biocurations.vue'
import TagsComponent from 'tasks/sources/filter/components/filters/tags.vue'
import IdentifierComponent from 'tasks/collection_objects/filter/components/filters/identifier.vue'
import ScopeComponent from 'tasks/nomenclature/filter/components/filters/scope.vue'
import OtusComponent from './filters/otus.vue'
import CollectionObjectComponent from './filters/collectionObjects.vue'
import AncestorTarget from './filters/ancestorTarget.vue'
