<template>
  <div
    class="smart__selector"
    ref="smartSelectorElement">
...
const actionKey = computed(() => navigator.platform.indexOf('Mac') > -1
  ? 'Control'
  : 'Alt'
)
...
const changeTab = e => {
  if (e.key !== actionKey.value) return

  tabselector.value.setFocus()
}
